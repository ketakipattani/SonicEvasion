...
public class AudioUtils {
	...
	*/
    ...
    public static void performData(byte[] data, long delay)
	throws IOException {

    	PlayThread p = new PlayThread( data, delay );
	
    }

    public static void performFile(File file, long delay) 
	throws IOException {
	ByteArrayOutputStream baos = new ByteArrayOutputStream();
	Encoder.encodeStream(new FileInputStream(file), baos);
	performData(baos.toByteArray(), delay);
    }
    
    public static void performArray(byte[] array, long delay) 
	throws IOException {
	ByteArrayOutputStream baos = new ByteArrayOutputStream();
    ...
    public static void performSOS(long delay) throws IOException {
    	ByteArrayOutputStream baos = new ByteArrayOutputStream();
